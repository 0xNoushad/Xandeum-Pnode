...
export function AnimatedCard({ className, ...props }: CardProps) {
    return (
        <div
            ...
            className={cn(
                "group/animated-card relative w-full h-full overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-sm dark:border-white/10 dark:bg-zinc-900/50 backdrop-blur-md transition-all",
                className
            )}
            {...props}
        />
...
const Layer1 = ({ color, secondaryColor }: LayerProps) => {
    return (
        <div className="ease-[cubic-bezier(0.6, 0.6, 0, 1)] absolute top-0 left-0 z-[6] transform transition-transform duration-500 group-hover/animated-card:translate-x-[-50%]">
            <svg
                className="h-full w-auto min-w-[700px]"
                viewBox="0 0 712 180"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
...
const Layer2 = ({ color }: LayerProps) => {
    return (
        <div className="absolute top-0 left-[-1px] h-full w-full">
            <svg
                className="h-full w-full min-w-[356px]"
                viewBox="0 0 356 180"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                preserveAspectRatio="none"
